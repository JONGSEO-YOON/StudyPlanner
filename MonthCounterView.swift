...
@IBDesignable class MonthCounterView: UIView {
        ...
        do {
            ...
            if(count != 0){
                ...
                for(i=0 ; i<count ;i += 1) {
                    ...
                    listTotal = match.value(forKey: "month") as! Int
    ...
    func totalTotalTime() -> Int {
        ...
        do {
            ...
            if(count != 0){
                var match = results[0] as! NSManagedObject
                var TotalTime = match.value(forKey: "month") as! Int
                
                while(i < count) {
                    
                    match = results[i] as! NSManagedObject
                    TotalTime = match.value(forKey: "month") as! Int
